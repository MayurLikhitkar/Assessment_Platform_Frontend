            ...
            {options.map((option) => {
                ...
                return (
                    <button
                        ...
                        className={twMerge(
                            'px-3 py-2 text-sm font-semibold rounded-lg cursor-pointer border border-primary-light/50 hover:border-primary-light focus:border-primary-light transition-colors outline-none',
                            isSelected
