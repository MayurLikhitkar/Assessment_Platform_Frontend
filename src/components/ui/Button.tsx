...
const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        primary: 'bg-primary-main hover:bg-primary-light text-text-inverse focus:ring-primary-light',
        secondary: 'bg-secondary-dark hover:bg-secondary-main text-text-inverse focus:ring-secondary-light',
        outline: 'border border-primary-main/40 hover:bg-primary-light/10 text-text-main focus:ring-primary-light',
        ...
        icon: 'bg-background-light text-text-light hover:text-error-main hover:bg-error-light/10 focus:ring-error-light',
