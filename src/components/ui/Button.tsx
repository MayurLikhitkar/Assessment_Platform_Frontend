...
const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        ...
        success: 'bg-success-main hover:bg-success-dark text-text-inverse focus:border-success-light',
        danger: 'bg-error-main hover:bg-error-dark text-text-inverse focus:border-error-light',
