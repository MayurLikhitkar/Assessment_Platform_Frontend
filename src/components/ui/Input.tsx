...
const baseStyles = "focus:outline-none focus:ring-2 ring-primary-dark/30 text-text-main transition-all duration-200"

const stylesByType: Record<string, string> = {
    default: "p-2 w-full rounded-lg ring ring-primary-dark/30",
    ...
    file: "w-full p-2 rounded-lg ring ring-primary-dark/30 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-dark/10 file:text-text-main hover:file:bg-primary-dark/20 file:cursor-pointer cursor-pointer",
}
